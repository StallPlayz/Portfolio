  ...
  <style>
    *,
    ...
    .skills-matrix {
      ...
      margin: 0 auto;
      padding: 40px;
      background: linear-gradient(135deg, rgba(0, 255, 242, 0.02), rgba(0, 100, 255, 0.02));
      border: 1px solid rgba(0, 255, 242, 0.2);
      border-radius: 20px;
      backdrop-filter: blur(10px);
      box-shadow:
        0 0 50px rgba(0, 255, 242, 0.1),
        inset 0 0 50px rgba(0, 255, 242, 0.05);
      overflow: hidden;
    }
    ...
    .skill-core {
      position: relative;
      background: linear-gradient(145deg, rgba(15, 22, 36, 0.8), rgba(0, 0, 0, 0.6));
    ...
    .skill-orbit {
      ...
      border: 2px solid transparent;
      border-radius: 15px;
      background: linear-gradient(45deg, transparent, rgba(0, 255, 242, 0.5), transparent);
      opacity: 0;
      transition: all 0.4s ease;
    ...
    .skill-node:hover .skill-core {
      ...
      background: linear-gradient(145deg, rgba(0, 255, 242, 0.05), rgba(0, 0, 0, 0.8));
    }

    .skill-node:hover .skill-orbit {
      opacity: 1;
    }
    ...
    .skill-node:hover .skill-content img {
      transform: scale(1.1);
    ...
    .skill-node:hover .skill-content h3 {
      color: white;
      text-shadow: 0 0 15px rgba(0, 255, 242, 0.8);
      transform: translateY(-2px);
    }

    .skill-node:hover .skill-content p {
      color: #00fff2;
      transform: translateY(-2px);
    }
    ...
    .skills-matrix::after {
      ...
      width: 100%;
      height: 100%;
      background: radial-gradient(circle at 50% 50%, rgba(0, 255, 242, 0.05) 0%, transparent 70%);
      pointer-events: none;
...
<body>
  ...
  <section id="about">
    ...
    <div class="about-container">
      ...
      <div class="about-right">
        ...
        <h2 class="aboutsubname" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600"></h2>
  ...
  <section id="skills">
    ...
    <!-- Futuristic container for skills -->
    <div class="skills-matrix" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
      <div class="matrix-grid">

        <a href="https://html.com" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="300">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/html.png" alt="HTML" />
              <h3>HTML</h3>
              <p>Markup Language</p>
            </div>
          </div>
        ...
        <a href="https://www.w3.org/Style/CSS/Overview.en.html" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="400">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/css.png" alt="CSS" />
              <h3>CSS</h3>
              <p>Styling & Design</p>
            </div>
          </div>
        ...
        <a href="https://javascript.com" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="500">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/javascript.png" alt="JavaScript" />
              <h3>JavaScript</h3>
        ...
        <a href="https://cplusplus.com" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="600">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/C++.png" alt="C++" />
              <h3>C++</h3>
        ...
        <a href="https://www.microsoft.com/en/microsoft-365/word" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="600">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/word.png" alt="C++" />
        ...
        <a href="https://www.microsoft.com/en-us/microsoft-365/powerpoint" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="600">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/powerpoint.png" alt="C++" />
        ...
        <a href="https://www.microsoft.com/en/microsoft-365/excel?market=af" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="600">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/excel.png" alt="C++" />
        ...
        <a href="https://terraria.org/" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="700">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/terraria.png" alt="Minecraft" />
              <h3>Terraria</h3>
              <p>Expert Builder & Strategy</p>
            </div>
          </div>
        </a>

        <a href="https://www.minecraft.net/en-us" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="700">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/minecraft.png" alt="Minecraft" />
              <h3>Minecraft</h3>
              <p>Builder & Designer</p>
            </div>
          </div>
        </a>

        <a href="https://www.sekirothegame.com" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="800">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/sekiro.png" alt="Sekiro" />
              <h3>Sekiro</h3>
              <p>Mastery & Precision</p>
            </div>
          </div>
        </a>

        <a href="https://en.bandainamcoent.eu/dark-souls/dark-souls-iii" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="900">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/ds3.png" alt="Dark Souls III" />
        ...
        <a href="https://www.factorio.com" target="_blank" class="skill-node" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="1000">
          <div class="skill-core">
            <div class="skill-orbit"></div>
            <div class="skill-content">
              <img src="/porto/src img/factorio.png" alt="Factorio" />
              <h3>Factorio</h3>
              <p>Engineering & Logic</p>
            </div>
          </div>
        </a>
...
.aboutsubname.glitch {
  animation: glitch-shake 0.3s infinite, skittle 2s infinite;
}

.aboutsubname.glitch::before,
.aboutsubname.glitch::after {
...
`;
    ...
    // JavaScript for glitch effect with text cycling
    function initGlitchSubtitle() {
      ...
      function changeText() {
        // Add glitch effect and data attribute
        subtitleElement.classList.add('glitch');
        subtitleElement.setAttribute('data-text', titles[currentIndex]);
        ...
        setTimeout(() => {
          ...
          subtitleElement.removeAttribute('data-text');
        }, 1000);
      }
      ...
      // Start cycling through texts
      setInterval(changeText, 4000); // Change every 4 seconds
    }

    // Inject the glitch CSS
    const styleSheet = document.createElement('style');
    styleSheet.textContent = glitchStyle;
    document.head.appendChild(styleSheet);

    // Initialize when DOM is loaded
    document.addEventListener('DOMContentLoaded', function() {
      // Wait for AOS animations to settle, then start the glitch animation
      setTimeout(initGlitchSubtitle, 1500);
    });
